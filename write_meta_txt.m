...
%
% Creates a .txt file with metadata for ADCP. Was specifically created for
% CORMP's OB27 as part of the 2021 SECOORA data challenge. 
% 
% Input is the filename format you want. For OB27 the input will be
% "YYYY_MMM_YYYY_MMM" which is the span of the deployment. The resulting
% file name will be meta_OB27_YYYY_MMM_YYYY_MMM.txt
%
% The ADCP data must be named "ADCP" and in the current working directory
%
eval(sprintf('filname = ''meta_OB27_%s.txt'';',num));
